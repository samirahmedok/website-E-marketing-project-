...
<link href="{{URL::asset('admin_assets/plugins/inputtags/inputtags.css')}}" rel="stylesheet">
<!--- Custom-scroll -->
...
src="{{URL::asset('admin_assets/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i></div>
</figure>
										</div>
...
src="{{URL::asset('admin_assets/js/tabs.js')}}"</script></code></pre>
<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i></div>
</figure>
										</div>
									</div>
...
<script src="{{URL::asset('admin_assets/plugins/inputtags/inputtags.js')}}"></script>
<!--- Tabs JS-->
