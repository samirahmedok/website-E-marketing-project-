...
<link href="{{URL::asset('admin_assets/plugins/fileuploads/css/fileupload.css')}}" rel="stylesheet" type="text/css"/>
...
<link rel="stylesheet" href="{{URL::asset('admin_assets/plugins/telephoneinput/telephoneinput-rtl.css')}}">
@endsection
@section('page-header')
				<!-- breadcrumb -->
							...
							<div class="card-body">
								...
								<div class="row mb-4">
									...
									<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
										<input type="file" class="dropify" data-default-file="{{URL::asset('admin_assets/img/photos/1.jpg')}}" data-height="200"  />
									</div>
									<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
...
<script src="{{URL::asset('admin_assets/plugins/fileuploads/js/fileupload.js')}}"></script>
<script src="{{URL::asset('admin_assets/plugins/fileuploads/js/file-upload.js')}}"></script>
