...
<script src="{{URL::asset('admin_assets/plugins/jquery-steps/jquery.steps.min.js')}}"></script>
<script src="{{URL::asset('admin_assets/plugins/parsleyjs/parsley.min.js')}}"></script>
