							...
							<div class=" card card--calendar p-0 mg-b-20">
								<div class="p-4 border-bottom">
									...
									<div class="text-center mx-auto">
										<img src="{{URL::asset('admin_assets/img/media/calendar.png')}}" alt="calendar" class="ht-80p wd-80p">
									</div>
								</div>
...
<script src="{{URL::asset('admin_assets/js/app-calendar-events.js')}}"></script>
<script src="{{URL::asset('admin_assets/js/app-calendar.js')}}"></script>
@endsection