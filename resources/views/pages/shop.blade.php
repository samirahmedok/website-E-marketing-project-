            ...
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                  <li class="mb-2" style="text-transform: capitalize"><a class="reset-anchor" href="{{route('boutique_cats',$category->id)}}">{{$category->cat_name}}</a></li>
                </ul>
                @endforeach
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white badge-"></div><a class="d-block" href="detail.html"><img class="img-fluid w-100" src="uploads/{{$product->image}}" alt="..."></a>
