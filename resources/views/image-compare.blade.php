...
<link href="{{URL::asset('admin_assets/plugins/images-comparsion/twentytwenty.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
				<!-- breadcrumb -->
						...
						<div class="card mg-b-20">
							<div class="card-body">
								...
								<div class="twentytwenty-container">
									<img src="{{URL::asset('admin_assets/img/photos/compare1.jpg')}}" alt="img" />
									<img src="{{URL::asset('admin_assets/img/photos/compare2.jpg')}}" alt="img" />
								</div>
							</div>
						</div>
						<!-- div -->
...
<script src="{{URL::asset('admin_assets/plugins/images-comparsion/jquery.twentytwenty.js')}}"></script>
<script src="{{URL::asset('admin_assets/plugins/images-comparsion/jquery.event.move.js')}}"></script>
<script src="{{URL::asset('admin_assets/js/image-comparision.js')}}"></script>
@endsection